  ...
  window.needShareButton = function (elem, options) {
    ...
    root.popup = function (url) {
      ...
      var popupWidth = 600,
        ...
        dualScreenLeft = window.screenLeft !== undefined ? window.screenLeft :
        screen.left,
        dualScreenTop = window.screenTop !== undefined ? window.screenTop :
        screen.top,
    ...
    function createDropdown(el) {
      ...
      if (myoptions.iconStyle == "default" && myoptions.boxForm ==
        "vertical") {
